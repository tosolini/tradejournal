    ...
    <div className="space-y-2">
      ...
      <div className="rounded border border-slate-700 bg-slate-900 px-2 py-2">
        <div className="mb-2 flex flex-wrap gap-2">
          {value.map((tag) => (
            <button
              ...
              className="rounded-full border border-teal-500/40 bg-teal-500/15 px-2 py-1 text-xs text-teal-200"
              title="Rimuovi tag"
            >
              {tag} ×
            </button>
        ...
        <input
          ...
          className="w-full bg-transparent px-1 py-1 text-sm text-slate-100 outline-none placeholder:text-slate-500"
        />
      </div>
        ...
        <div className="flex flex-wrap gap-2">
          {availableSuggestions.map((suggestion) => (
            <button
              ...
              className="rounded-full border border-slate-600 bg-slate-800 px-2 py-1 text-xs text-slate-300 hover:border-teal-500/50 hover:text-teal-200"
            >
              {suggestion}
            </button>
          ))}
